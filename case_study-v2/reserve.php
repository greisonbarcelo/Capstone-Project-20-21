    ...
    if (isset($_POST['submit'])) {
        ...
        if ($daynight_validation == "valid" && $roomcottage_validation == "valid" && $people_validation == "valid" && $adults_validation == "valid" && $kids_validation == "valid" && $seniorcitizen_validation == "valid" && $amount_validation =="valid"){
            ...
            if (!$insert_into_db) {
                ...
                //$res_id_get = ("SELECT reservation_id FROM tbl_reservations WHERE user_id = '$_SESSION[user_id]'");
                ...
                while($rows = mysqli_fetch_assoc($select)){
                    ...
                    $reservation_insert = mysqli_query($con, "UPDATE tbl_users SET reservation_id = ('$reservation_id') WHERE user_id = '$_SESSION[user_id]'");
                }

                
                echo "<script>alert('Please proceed to payment!');window.location.href='payment.php'</script>";
            }
        }
        else{
