...
<body>
    <nav class="navbar fixed-top navbar-expand-sm navbar-light bg-light">
         ...
         <div class="sidebar mr-5">
           ...
           <a href="userdash.php" class="active" >Users Dashboard</a>
                    ...
                    <tr>
                        <?php 
                            ...
                            while ($row = mysqli_fetch_assoc($select)) {
                                    ...
                                    echo "<td class='td'>". $row['user_password'] . '</td>';
                                    echo "<td class='td'>". $row['user_fname'] ." " . $row['user_lname'] . '</td>';
                                    echo "<td class='td'>". $row['user_age'] . '</td>';
                                    echo "<td class='td'>". $row['user_gender'] . '</td>';
                                    echo "<td class='td'>". $row['user_email'] . '</td>';
                                    echo "<td class='td'>". $row['user_number'] . '</td>';
