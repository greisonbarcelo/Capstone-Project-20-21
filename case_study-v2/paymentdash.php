...
<body>
    <nav class="navbar fixed-top navbar-expand-sm navbar-light bg-light">
         ...
         <div class="sidebar mr-5">
           ...
           <a href="paymentdash.php" class="active" >Payments</a>
         </div>

         <div class="content container">
            <center>
                <span><h1>Payments<h1></span>
                <table>
                    <tr>
                       <th>Payment ID</th>
                       <th>Amount</th>
                    ...
                    <tr>
                        <?php 
                            ...
                            while ($row = mysqli_fetch_assoc($select)) {
                                    ...
                                    echo "<td class='td'>". $row['payment_amount'] . '</td>';
                                    echo "<td class='td'>". $row['payment_method'] . '</td>';
                                    ...
                                    if ($row['payment_approval'] == 1) {
                                        echo "<td class = 'td' style = 'color: orange;'>" . "Pending" . "</td>";
                                    }
                                    //echo "<td class='td'>". $row['payment_approval'] . '</td>';
