...
<body>
	<div class="w3-top">
	  <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
	    <a href="#userhome" class="w3-bar-item w3-button">Almon Waterpark</a>
	    ...
	    <div class="w3-right w3-hide-small">
	      ...
	      <a href="#userabout" class="w3-bar-item w3-button">About</a>
	      <a href="#userroomscottage" class="w3-bar-item w3-button">Rooms & Cottages</a>
	      <a href="#useramenities" class="w3-bar-item w3-button">Amenities</a>
	    </div>
	  </div>
	</div>

	<div id="userhome" class="w3-container w3-padding-32 w3-center"> <br> <br>
	...
	<div id="userroomscottage" class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:0px"><br> <br>
		...
		<a href="finalreserve.php"><button class="w3-button w3-block w3-black w3-margin-bottom">Reserve Now</button></a>
	</div> <hr>

	<div id="useramenities" class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:-10px"> <br><br>
		<h3>Amenities</h3>
		<div class="w3-row-padding w3-padding-16">
		  <div class="w3-third w3-margin-bottom">
	...
	<div id="userabout" class="w3-container w3-padding-32 w3-center">
